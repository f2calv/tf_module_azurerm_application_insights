...
This repository publishes a single reusable Terraform child module that provisions an Azure Application Insights component, optionally wired to a Log Analytics workspace supplied by the caller.
